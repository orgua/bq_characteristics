...
cfg_bq25570_base = VirtualSourceConfig(
    ...
    V_intermediate_max_mV=4180,
    V_intermediate_enable_threshold_mV=2430,
    V_intermediate_disable_threshold_mV=2030,  # difference to _var2
    V_pwr_good_enable_threshold_mV=2990,
    V_pwr_good_disable_threshold_mV=2790,
    V_output_mV=1800,
    C_output_uF=22,
)
...
cfg_bq25570_eval = VirtualSourceConfig(
    ...
    harvester=VirtualHarvesterConfig(
        ...
        interval_ms=15230,  # from recording
        duration_ms=233,  # from recording
        samples_n=700,  # TODO: fixes bug in CoreLib
        setpoint_n=0.8,
    ),
    enable_feedback_to_hrv=False,  # disable newer feature
    # eval board spec & modification
    ...
    V_pwr_good_disable_threshold_mV=2790,
    V_output_mV=1800,
    C_output_uF=22,  # observation: 900mA-trace shows ~175mV drop when enabling buck
